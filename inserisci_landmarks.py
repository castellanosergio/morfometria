...
class LandmarkPlugin:
    ...
    def activate(self):
        ...
        #   self.viewer.landmarks = landmarks.landmarks_dict
    ...
    def handle_click(self, name, pos):
        ...
        for i in range(len(coordinate_punti)):
            if coordinate_punti[i]:
                lista_qpointf.append(QPointF(coordinate_punti[i][0], coordinate_punti[i][1]))
        self.viewer.layer_manager.draw_points("landmarks", lista_qpointf, color=QColor(255, 0, 0, 180))
